...
FROM   (select * from :year_total) t_s_firstyear, 
      (select * from :year_total) t_s_secyear, 
       (select * from :year_total) t_c_firstyear, 
       (select * from :year_total) t_c_secyear, 
       (select * from :year_total) t_w_firstyear, 
       (select * from :year_total) t_w_secyear 
